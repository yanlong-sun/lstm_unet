...
prediction_path = '../pred_compare/2p5dDenseUnet_21001/';
...
%% plot
figure(1)
x = [[dice_coef_dl2p5d'], [dice_coef_bse'], [dice_coef_denseunet']];
...
legend({['2p5D DenseUnet: ', num2str(dice_dl2p5d_avg)], ['Brainsuite: ', num2str(dice_bse_avg)], ['DACN: ', num2str(dice_denseunet_avg)]}, 'Location','southwest');
